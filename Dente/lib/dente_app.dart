...
import 'package:dente/src/pages/convenio/convenio_router.dart';
...
import 'package:dente/src/pages/payment/payment_router.dart';
import 'package:dente/src/pages/plano/plano_router.dart';
    ...
    return ApplicationBanding(
      child: MaterialApp(
        ...
        routes: {
          ...
          Rotas.payment: (context) => PaymentRouter.page(),
          Rotas.convenio: (context) => ConvenioRouter.page(),
          Rotas.premium: (context) => PlanoRouter.page(),
        },
      ),
    );
  }
