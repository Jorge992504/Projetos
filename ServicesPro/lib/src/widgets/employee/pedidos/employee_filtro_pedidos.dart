...
class EmployeeFiltroPedidos extends StatelessWidget {
  final int isSelec;
  final void Function()? onPressedCancelados;
  final void Function()? onPressedEmAndamento;
  final void Function()? onPressedFinalizados;
  const EmployeeFiltroPedidos({
    super.key,
    required this.isSelec,
    this.onPressedCancelados,
          ...
          child: Row(
            ...
            children: [
              ...
              Container(
                ...
                child: TextButton(
                  onPressed: onPressedCancelados,
                  child: Text('Cancelados', style: context.cusotomFontes.bold),
                ),
              ),
            ],
          ),
