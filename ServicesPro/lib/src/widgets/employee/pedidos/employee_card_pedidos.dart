...
import 'package:servicespro/src/widgets/employee/pedidos/employee_bottum_finalizar.dart';

class EmployeeCardPedidos extends StatelessWidget {
  final bool isDark;
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      EmployeeBottumFinalizar(
                        onPressedFinalizar: onPressedFinalizar,
                      ),
                    ],
                  ),
                ],
